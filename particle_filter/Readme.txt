...
very slow to execute and for 1000 particles and all iterations can take multiple hours to
execute. The user can select partially executing the program for 2000 iterations, which 
