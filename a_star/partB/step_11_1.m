...
[x_path, y_path,closed_list,open_list,child_list,gcost_grid,move_grid,open_list_tracker] = astar_11_1(figure_no,s,g,closed_list,open_list,child_list,gcost_grid,move_grid,open_list_tracker);
pos1 = [s(1)		s(2)]	;
pos2 = [x_path   y_path];
