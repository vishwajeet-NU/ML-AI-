...
title("astar grid size= 1, planning + p-controller, yellow = expanded nodes, pink = path, blue = controller path");
...
while((abs(s(1) - g(1)))>0.1 || (abs(s(2) - g(2)))>0.1) #continue looping until the robot hasnt reached inside this threshold to goal
[x_path, y_path,closed_list,open_list,child_list,gcost_grid,move_grid,open_list_tracker] = astar_11_2(figure_no,s,g,closed_list,open_list,child_list,gcost_grid,move_grid,open_list_tracker);
pos1 = [s(1)		s(2)]	;
pos2 = [x_path   y_path];
